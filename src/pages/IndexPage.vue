  ...
  <div class="index-page">
    ...
    <div class="index-right">
      ...
      <div class="index-board-list">
        <div class="index-board-item" v-for="(item,index) in boardList" :key="item.id" :class="[{'line-last':index%2!==0},'index-board-'+item.id]">
          <div class="index-board-item-inner" >
            <h2>{{item.title}}</h2>
            <p>{{item.description}}</p>
            <div class="index-board-button">
              <router-link to="/detail" class="button">立即购买</router-link>
            </div>  
          </div>
        </div>
      </div>
